...
- [x] **T3.1.2** 管理画面での CRUD 操作実装（基本的なUI）
- [ ] **T3.1.3** 状態管理（Context / Zustand）（JSONベースで実装済み）

#### 3.2 ホラー要素: レベル1（表層）
> 管理画面で最初に気づく違和感

- [x] **T3.2.1** 統計の微妙な不整合
  - 例: 表示件数と実際の件数が1つずれる（実装済み）

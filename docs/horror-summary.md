...
- **内容**:
  - 3段階の異常レベル（subtle, noticeable, severe）
...
| 画面 | レベル | ホラー要素 | データ |
|------|--------|-----------|--------|
| ダッシュボード | 1 | 投稿数の不整合 | posts.length = 7（実際は6件） |
...
| 実績一覧 | 2 | 封印済み | work-006: status: "sealed" |
| 実績一覧 | 2 | 墨塗り | work-006: client/venue = "███" |
| 実績編集 | 3 | 封印警告 | work-006: 警告ボックス |

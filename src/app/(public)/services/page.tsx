...
export const metadata: Metadata = {
  ...
  description: 'crayte studioが提供するサービスをご紹介します。Web制作、イベント企画・運営、映像制作を通じて、クライアントの価値創造をサポートします。',
};
...
export default function ServicesPage() {
  ...
  const flow = [
    { step: 1, title: 'お問い合わせ', description: 'まずはお気軽にご相談ください' },
    { step: 2, title: 'ヒアリング', description: 'ご要望や課題をお伺いします' },
    { step: 3, title: 'ご提案・お見積もり', description: '最適なプランをご提案します' },
